 ...
 *
 * 모델을 확인 단에서 고르게 두면 설정과 고르개가 갈라져, 켜 놓고 확인 탭까지 다녀와야 합니다.
 *
...
export default function BatchToolsField({
  ...
  */
  ...
  /*
    ── 화면 비율 ──────────────────────────────────────────────────────────
    이미지와 영상은 비율이 다릅니다 — 숏츠로 낼 영상은 세로로 뽑아야 합니다.
  ...
  const modelPick = (
    ...
    return (
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {/*
          목록을 **손으로 받아 올 수 있게** 합니다 — 마그니픽에 붙어 있으면 모델도 해상도도
          그쪽이 아는 것이 맞고, 도중에 늘어난 모델은 다시 물어야 보입니다.
        */}
        <button
          type="button"
    ...
    <div className="space-y-1.5">
      ...
      */}
      ...
      {/*
        ...
        한 번에 뽑을 때도 그림에 따라 로라를 갈아 끼워야 합니다.
