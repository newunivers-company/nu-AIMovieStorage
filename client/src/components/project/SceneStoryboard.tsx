 ...
 *
 * 한 장면은 컷 여러 개로 이뤄져 있으니 스토리보드도 **장면마다** 한 장입니다. 6000×6000 으로
 * 굽는 까닭은 그 한 장을 그대로 생성기에 올려 영상까지 뽑기 때문입니다 — 칸이 작으면 인물이
 * 뭉개져 스왑이 안 걸립니다.
 *
 * # 왜 장면 화면에 두는가
 *
...
export default function SceneStoryboard({
   ...
   *
   * 점검에서 드러났습니다 — 씬 영상 프롬프트에 화면비가 아예 안 실리고 있었습니다.
   */
  videoAspect?: string;
}) {
  ...
  */
   ...
   *
   * 인물 스왑뿐 아니라 vfx·배경·소품 스왑까지 한 글에 들어 있어야 합니다.
        ...
        return {
          ...
          /*
            **영문 카메라 문장도 함께 보냅니다.**
            ...
            점검에서 드러났습니다 — 한국어만 보내고 있었습니다. 그래서
