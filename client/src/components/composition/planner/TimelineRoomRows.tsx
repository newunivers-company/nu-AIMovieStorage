 ...
 *
 * 면은 저마다 레이어가 아니라 **한 방의 속성**이라, 방 한 줄 아래 접어 넣습니다. 소품 투시도 같은 자리에서
 * 키를 찍습니다.
 *
 * `MoveTimeline` 에서 떼어 냈습니다 — 3,400줄 한 컴포넌트에서 «방 줄이 어디더라» 를
        ...
        {roomsOf(state).map((room) => {
          ...
          return (
            <div key={room.id}>
              ...
              {/*
                ── 이 방의 소품 · 투시 ──────────────────────────────────
                벽에 붙인 소품도 때에 따라 투시로 비쳐야 해서, 그 켜고 끔을 시각에 걸 수 있어야 합니다.
