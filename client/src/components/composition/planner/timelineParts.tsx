 ...
 *
 * 이동량·길이 칸이 옆에 선 단추들과 크기가 달라 줄이 들쭉날쭉했습니다. 공용
 ...
 * 어두운 화면에 맞춘 **고르기 단추**.
 *
 * 브라우저 기본 `<select>` 는 펼친 목록의 글자가 거의 안 읽혔습니다. 그 펼친
...
export function TimelineSelect({
   ...
   *
   * 자유 경로 클립에서 «이어서» 목록을 펴면 카메라가 하나도 안 보였습니다.
 ...
 *
 * 이동량이든 회전이든 숫자만 있고 기준이 없으면 몇을 넣어야 할지 알 수가 없습니다 —
 ...
 * 이름표를 덮어 두 글자 이름이 한 글자로 보였습니다. 애프터이펙트처럼
...
export const ANCHOR_SPOTS = [
  // 사람 키를 1 로 본 실제 비율. 처음 값(가슴 0.62 / 허리 0.45)은 한 칸씩 아래라,
  // 가슴이 허리에, 허리가 사타구니에 앉았습니다.
