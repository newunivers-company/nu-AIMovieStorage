 ...
 *
 * 관절 목록이 여러 겹으로 겹쳐 무엇을 고르는 중인지 알 수 없었습니다. 그래서 커서를
 * 한가운데 두는 원으로 바꾸고, 상체·왼쪽·오른쪽 셋에서 팔·팔꿈치·손·손가락으로 한
 * 걸음씩 내려가게 했습니다 — 자세를 몸의 순서대로 맞춰 나가라는 뜻입니다.
 *
 * # 왜 네모 목록이 아니라 원인가
 *
...
export function BonePicker({
  ...
  /*
    ...
    한동안 Esc 였는데, Esc 는 편집 창(Radix Dialog)을 닫는 키라 첫 고리에서 한 번 더
    누르면 구도잡기가 통째로 꺼졌습니다. 한 걸음 뒤로 가려다 창을 잃는 셈입니다.
    Tab 이 여는 키니 그 짝으로 Ctrl+Tab 이 자연스럽습니다.
  */
  useEffect(() => {
