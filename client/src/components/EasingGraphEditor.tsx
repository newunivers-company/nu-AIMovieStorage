 ...
 *
 * 기본은 속도 쪽입니다. 카메라 무빙에서 사람이 실제로 느끼는 것은 «얼마나 왔는가» 가
 * 아니라 «지금 얼마나 빠른가» 이고, 그것이 눈에 보이는 모양이 포물선입니다.
 *
  ...
  */
  ...
  const handleMove = (event: React.PointerEvent<SVGSVGElement>) => {
    ...
    /*
      ...
      애프터이펙트의 «영향(influence)» 도 두 손잡이가 서로를 넘지 못합니다. 안 막으면
      출발 손잡이가 도착 손잡이를 지나쳐 곡선이 스스로 접히고(«되감기는» 무빙),
      화면에서는 두 점이 겹쳐 어느 것을 잡았는지도 알 수 없습니다 — 실제로 겹쳤습니다.
    */
