 ...
 * # 왜 «받아 둔 것만» 인가
 *
 * 여태 목록은 손으로 적어 둔 **경로**였습니다. 파일을 옮기거나 지워도 목록은 남아, 뽑기를
 * 눌러 봐야 «없는 파일» 로 엎어집니다. 이제 엔진 폴더를 읽어 **있는 것만** 내놓습니다.
 *
 * # 아무것도 안 고르면
 *
 * 설정에서 «기본으로 켜 둔» 것들이 들어갑니다. 고르면 **고른 것만** 들어갑니다 —
 * 이번 컷만 다른 화풍으로 가려면 기본을 건드리지 않고 여기서 갈아 끼울 수 있어야 합니다.
 */
export default function LoraPicker({
  ...
  /*
    **한 줄입니다.** 예전에는 «라벨·안내·폴더» 줄과 «칩» 줄로 나뉘어 있어서, 컷 카드의 머리줄
    오른쪽에 붙으면 로컬 영상 단추 아래로 두 줄이 매달려 단추 줄이 뒤죽박죽으로 보였습니다.
    안내문은 라벨의 툴팁으로 옮기고, 고른 개수만 글자로 남깁니다.
  */
  return (
