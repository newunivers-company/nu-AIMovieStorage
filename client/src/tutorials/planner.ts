...
/*
  ...
  구도잡기는 기능이 워낙 많아 한 벌로 묶을 수가 없습니다 — 한 튜토리얼이 열두 걸음을
  넘으면 어디까지 봤는지 잊습니다. 작업하다 막혔을 때 막힌 갈래만 골라 보라고 쪼갰습니다. 창 훑어보기 · 방과 환경 · 인물과 포즈 · 소품 · 카메라 · 타임라인 · 레퍼런스 영상 ·
...
const CHARACTERS: Tutorial = {
  ...
  steps: [
    ...
    step({
      ...
      anchor: "layout-hands",
      title: "손 모양",
      // 내장 손 프리셋은 PosePanel 에서 걷어냈습니다 — 직접 맞춰 프리셋으로 저장해 쓰는 길만 남겼습니다. 화면에 있는 것만 적습니다.
      body:
