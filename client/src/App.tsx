 ...
 * 화면 배치.
 *
 * 작업실(`/workspace/:id`)은 **걷어냈습니다** — 앞 단계 화면에 이미 있는 내용을
 * 그대로 되풀이하는 자리였습니다. 프로젝트를 골라 들어가면 곧장
  ...
  */
  ...
  /*
    **앱이 고친 프롬프트 문구를 폴더에 흘려보냅니다.**
    ...
    앱이 아무리 고쳐도 영영 안 갑니다 — 컷의 대사·연출 칸을 새로 붙였는데 먼저 깔린
    사본에 가려 **한 컷도 안 들어온 적이 있습니다.** 코드도 프롬프트도 멀쩡해 보여서
    원인을 찾는 데 한참 걸립니다.
  ...
  return (
    <ErrorBoundary>
      ...
      {/*
        ...
        아무 일이 없었습니다 — 타임라인 총 길이·FPS 를 물어도, 키프레임 이동량을 물어도
        값을 적을 자리가 뜨지 않았습니다.
      */}
      <PromptDialogHost />
      {/*
