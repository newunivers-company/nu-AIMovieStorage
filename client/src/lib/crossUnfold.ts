 ...
 *
 * 여섯 면은 **한 장에 한꺼번에** 뽑습니다. 한 장에 십자로 펼쳐 그리면
 ...
 *
 * 실내든 실외든 여섯 면 어디에도 회색 테두리가 남으면 안 됩니다 — 상자에 붙이면 테두리가
 * 여섯 면에 다 보입니다. 생성기가 판 사이를 붙이지 않고 회색 틈을 남기는데, 자르는 선은 그
...
export function trimBackgroundEdges(
  ...
  */
  ...
  /*
    ...
    바탕 줄을 벗겨도 **칸 경계의 회색 선**은 남습니다. 나노 바나나는 칸 사이에 바탕보다 밝은 회색이나 흰 줄을
 ...
 *
 * 전개도 자르는 선이 판 경계에서 조금씩 틀어져, 틀이 칸에 정확히 들어가지 않았습니다.
 ...
 * 이 그림이 **십자 전개도로 보이는가.**
 *
 * 배경 여섯 면은 규격을 정해 뽑으니, 자르고 저장하는 데까지 사람 손이 갈 까닭이 없습니다.
 * 다만 자동으로 자르려면 «이건 전개도다» 를 앱이 확신해야 합니다 —
