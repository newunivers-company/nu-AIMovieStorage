 ...
 * (안 적으면 5.5×5.2×4.4 같은 기본값으로 서서, 넓은 창고를 바랐어도 작은 방이 나옵니다.)
 */
  ...
  */
  ...
  /*
    **방이 세워진 구도.** 이것이 없으면 구도잡기를 열어도 방이 없어, 타임라인의 «방 · 가릴 면 · 소품»
    줄과 환경 탭의 방 목록·면 가리기가 **아예 안 그려집니다** — 안내가 없는 자리를 가리켜
    단추를 누를 수도, 화면을 열 수도 없게 됩니다.
...
export function tutorialSampleReady(): boolean {
  ...
  /*
    **전개도까지 있어야 «다 됐다» 입니다.** 전개도를 넣기 전에 만든 예시에는 여섯 면이 없어서,
