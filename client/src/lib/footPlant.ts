 ...
 *
 * 쓸지 말지는 체크박스로 고릅니다 — 언제든 걷어낼 수 있게 경계를 뚜렷이 두었습니다.
 *
 * # 왜 따로 사는가
 *
 ...
 * 포즈 IC-LoRA 에 먹이면 **뽑힌 영상에서도 발이 미끄러집니다**(실측 확인).
 *
...
function trackFeet(rig: RetargetRig, frames: RetargetFrame[]): FootTrack[] {
  ...
  /*
    **«수평» 의 기준은 0° 가 아닙니다.**
    ...
    을 재면 제대로 디딘 발이 전부 걸러집니다 — 첫 시험에서 36편 중 24편이 «디딘 발
    0곳» 으로 나온 까닭입니다.
