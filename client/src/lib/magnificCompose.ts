 ...
 *
 * 실제 일은 Rust `magnific_compose_auto` 가 마그니픽 데스크톱을 CDP 로 조종해 합니다:
...
/** 마그니픽 보드의 생성기가 쓰던 모델 슬러그(화면 이름 «Nano Banana Pro»). 마그니픽에서 바꿔도 됩니다. */
export const MAGNIFIC_IMAGE_MODEL = "imagen-nano-banana-2";

/**
 * 영상 생성기의 기본 모델.
 *
 * 컷 하나가 그대로 영상이 되는 길입니다 — 구도잡기에서 뽑아 둔 영상이 있으면 그것을
 * 레퍼런스 영상으로 걸고 곧장 영상을 뽑습니다.
 *
