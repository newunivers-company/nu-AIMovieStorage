 ...
 * **BGM 뽑기도 작업 줄에서.**
 *
 * BGM 만 작업 줄에 안 보이던 때가 있었습니다 — 제 화면 안에서 `await` 로 돌았습니다. 그래서 그 화면을 벗어나면
 ...
 * # 어디에 놓이는가
 *
 * `BGM/곡/<프로젝트>/` 입니다. **영상 프로젝트 폴더가 아닙니다** — 한 곡을 여러 영상에서
 * 돌려 쓰는데 프로젝트 폴더에 두면 그 프로젝트를 지울 때 곡까지 사라지고, 같은 곡이
 * 프로젝트마다 복사본으로 늘어납니다.
 *
