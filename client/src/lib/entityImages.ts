 ...
 *
 * 예전 컷 카드는 `generatedImages.slice(0, 2)` — 원본 앞 두 장뿐이었습니다. 인물이 그림을
 * 넷 만들어 두어도 둘만 떴고 변형·시트·보유 에셋·공용 에셋이 전부 빠져 있어, 2단계에서
 * 만든 것이 3단계에서 안 보였습니다. 에셋은 공용인지 그 인물 것인지까지 가려 보여야
 * 무엇을 고르는지 압니다.
 *
