 ...
 *
 * 길은 둘이었습니다 — 모델마다 프롬프트를 따로 적게 하거나, 적어 둔 프롬프트 하나를
 * 보내는 순간에 모델 말로 고치거나. **뒤쪽을 골랐습니다.**
 *
 ...
 * 다 적어 길고 **칸 배치 지시가 맨 뒤**에 있어서, 넘치면 정확히 그 부분이 날아갑니다.
 ...
 *
 * 실측(Qwen-Image, 같은 씨앗으로 칸 넉 장): 「full body」·「head to toe in frame」 을
...
export function tuneForLocal(
  ...
  /*
    ...
    되면서 드러났습니다. 가르는 규칙은 `splitLinkTail` 한 벌.
  */
