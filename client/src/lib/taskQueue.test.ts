...
/*
  저장 전 프로젝트(«새 프로젝트»)가 첫 자동 저장으로 열쇠를 얻으면 줄에 선 일도 따라가야 합니다 — 안 따라가면
  일괄 생성 4단계의 남은 카드가 전부 옛 열쇠로 실패하고 4단계가 영영 안 닫힙니다. 러너가 등록되지 않은 시험이라 줄은
...
/*
  이어 받을 열쇠 — 앱을 껐다 켜도 돌던 LLM 왕복을 이어 받아야 합니다.
