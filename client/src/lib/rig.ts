 ...
 *
 * 자세에도 카메라처럼 키프레임을 찍습니다. 그런데 자세가 바뀔
 ...
 * 가장 가까워 「저 자리에 저 크기로 선다」 를 눈으로 가늠하기 쉽습니다. 그래서 A 포즈가
 * 아니라 차렷으로 세웁니다.
 *
 * 내장 포즈 프리셋(걷기·달리기·앉기…)은 함께 걷어냈습니다 — 동작이 어설픈 데다, 쓸 자세는
 * 그때그때 만들어 담아 두는 쪽이 낫기 때문입니다.
